        ...
        <div class="columns">
            <div  class="column is-one-quarter" style="padding: 50px 0px;">
                    <p id="phraseHome">
                        ...
                        il y a eu <b><?php echo  nf($kpi['nombre']) ; ?></b> marchés pour</br>
                        un total de <b><?php echo nf($kpi['montant_total']) ; ?></b> €
                    </p>
            </div>
            <div class="column" >
...
<!--        <h1 class='is-size-4 is-size-4-mobile'>--><?php //echo gettext("Données essentielles du profil d'acheteur de");  echo(" "); echo _("Mégalis Bretagne") ?><!--</h1>-->
        ...
        <h2 id="dates" class="has-text-centered subtitle">Cet outil exploite les données essentielles des marchés publics passés en 
            <?php echo gettext("NOM_REGION"); ?> sous réserves que l'organisme qui passe le marché public soit 
      ...
      <span class='tags has-addons'>
        <span class='tag is-light'><?php echo gettext("Contrats conclus à partir du ") ?></span>
        <span class='tag is-warning'><?php echo $donnees_a_partir_du;?></span>
        <span class='tag is-light'><?php echo gettext("Données mises à jour le ") ?></span>
    ...
    <div class="container">
        <h3><?php echo gettext("Indicateurs clés") ?></h3>
        <p><?php echo gettext("Principaux indicateurs des ") ?><b><?php echo $nb_mois;?><?php echo gettext("  derniers mois")?></b>.</p>
