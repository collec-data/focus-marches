...
# sql
# --------------------
$sql = 'SELECT DISTINCT m.id, m.id_marche, m.date_notification, nom_acheteur, denomination_sociale, m.code_cpv, libelle_cpv, duree_mois,  montant, l.code as code_dept, l.nom_lieu as nom_dept, date_notification, objet, s.latitude, s.longitude
        FROM `marche` m
