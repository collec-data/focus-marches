...
normalize
---------------------------
normaliser la taille des bulles des montants
...
$(document).ready(function () {
  ...
  // var zoom = 6;
  // var map = L.map('map').setView(dijon, zoom);

  // almacenalos marcadores pra podelos suprimir
  var markers = [];
...
$(document).ready(function () {
  ...
  // almacenalos marcadores pra podelos suprimir
  var markers = [];
  // almacenalos montants pra poder normalizalos
  var montants = [];
