...
$title = "Mentions légales | Données essentielles du profil d'acheteur de Territoires Numériques";
$desc = "Mentions légales | Données essentielles du profil d'acheteur de Territoires Numériques";
...
<div id="main">
  ...
  <p>Le site Focus Marchés est édité par le GIP Territoires Numériques Bourgogne-Franche-Comté. Il est accessible via plusieurs URLs :</p>
  <ul>
  ...
  <p>Directeur de la publication&nbsp;: Gilles Delamarche<br>
    Conception et réalisation&nbsp;: Territoires Numériques, téléphone : <strong>03 80 20 04 20</strong>, e-mail : <b>contact@ternum-bfc.fr</b><br>
    Hébergement&nbsp;: OVH</p>
  <p>
...
<h3 class="title is-3">2. Qui est le Responsable des traitements, et le Délégué à la Protection des Données&nbsp;?<br></h3>
<p>
	<b>Responsable du traitement</b><br>
	Le responsable du traitement des données à caractère personnel est : M Gilles DELAMARCHE. Il peut être contacté de la manière suivante :<br>
	Téléphone : 03 80 20 04 20<br>
	E-mail : <a href="mailto:contact@ternum-bfc.fr">contact@ternum-bfc.fr</a>
</p>
<p>
	<b>Délégué à la Protection des Données</b><br>
	La personne suivante a été nommée Délégué à la Protection des Données : M Victor VILA. Il peut être joint de la manière suivante :<br>
	Téléphone : 03 80 20 04 20<br>
	E-mail : <a href="mailto:dpo@ternum-bfc.fr">dpo@ternum-bfc.fr</a>
</p>
<h3 class="title is-3">3. Quels sont vos droits concernant vos données à caractère personnel&nbsp;?</h3>
<ul>
  <li>
...
<h3 class="title is-3">4. Comment exercer vos droits ?</h3>
<p> Pour faire valoir vos droits, vous pouvez contacter le Délégué à la Protection de Données du GIP Territoires Numériques M Victor VILA qui peut être joint par téléphone au 03 80 20 04 20 ou par e-mail à l'adresse <a href="mailto:dpo@ternum-bfc.fr">dpo@ternum-bfc.fr</a> .
</p>
<h3 class="title is-3">5. Quelles sont les obligations du Responsable des traitements&nbsp;?</h3>
<p>
...
<p>
  ...
  <p>La présente décharge de responsabilité concerne le site Focus Marchés.</p>
  <p>Territoires Numériques n’est tenu que d’une simple obligation de moyens concernant les informations qu’elle met à disposition des personnes qui accèdent à son site Internet. Territoires Numériques ne peut encourir aucune responsabilité du fait d’erreurs, d’omissions, ou pour les résultats qui pourraient être obtenus par l’usage de ces informations. Notamment, l’usage de liens hypertextes peut conduire votre consultation de notre site vers d’autres serveurs pour prendre connaissance de l’information recherchée, serveurs sur lesquels Territoires Numériques n’a aucun contrôle.</p>
  <p><strong>Ce site Internet a été créé afin de montrer le potentiel des données ouvertes, cépendant nous ne pouvons pas garantir ni l'exactitude ni la complétude des données ouvertes sur lesquelles s'appuie le site</strong>.</p>
  <h2 class="title is-2">Droits d’auteurs</h2>
  <p>Ces données publiées sont publiées sous la <a href="pdf/ETALAB-Licence-Ouverte-v2.0.pdf">Licence Ouverte Version 2.0 - Etalab</a></p>
  <p>Le <a href="https://marches.ternum-bfc.fr/?page=entreprise.EntrepriseRechercherListeMarches&search">téléchargement des données</a> se fait librement sur notre salle de marchés.</p>
  ...
  <ul>
    <li>Données essentielles de la commande publique du profil d'acheteur de Territoires Numériques.  Licence Ouverte / Open Licence version 2.0 .</li>
    <li>Codes CPV : simap.ted.europa.eu</li>
    <li>Populations légales 2015 : https://www.insee.fr/fr/statistiques/3292701</li>
    <li>API SIRENE. Licence Ouverte / Open Licence version 2.0 </li>
    <li>API GEO : geo.api.gouv.fr. Licence Ouverte / Open Licence version 2.0 </li>
    <li>Codes NAF (INSEE)</li>
    <li>Codes NAFA (INSEE)</li>
    <li>Catégories juridiques (INSEE)</li>
  </ul>
</div>
</div> <!-- ./ main -->
