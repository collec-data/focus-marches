            ...
            if ($iframe == false){
                ...
                <div>
                    <p class="has-text-right">
                        <button class="button has-text-link is-link-bg is-small" data-clipboard-text="http://127.0.0.1:8080/edsa-focus-marches-new/ui/widget-acheteur-distrib-temporelle.php?i=24360023600018&widget=1" ><i class="fa fa-code"></i>&nbsp;intégrer le widget</button></p>
                </div>
                <?php
            }
            ?>
