...
xaxis: { autorange: true, showgrid: false, zeroline: false, showline: false, autotick: true, ticks: '', showticklabels:
false },
yaxis: { autorange: true, showgrid: false, zeroline: false, showline: false, autotick: true, ticks: '', showticklabels:
false },
/*paper_bgcolor: "#4fb2db ",plot_bgcolor: "#4fb2db"*/
};

var layoutCategories = { showlegend: false, autosize: true, hovermode:'closest', height: 350, margin: { l: 50, r: 50, b:
60, t: 20, pad: 0}, showticklabels: false };
...
{
Plotly.newPlot( id, [{ x: x, y: y, type: 'scatter',mode: 'lines+markers',line: {shape: 'spline', color: "#4fb2db" }}],
layoutCols, {displayModeBar: false} );
};

var barPlot = function (id, x, y, couleur, border)
{
Plotly.newPlot( id, [{ x: x, y: y, type: 'bar', marker: {color: couleur,line: { color: border, width: 1 } }}],
layoutCols, {displayModeBar: false} );
};
...
var chartData = [{ type: 'bar', y: y, x: x, marker:{ color: okabe_ito_reverse, line: { color: okabe_ito_reverse, width:
1 } }, orientation: 'v'}];
