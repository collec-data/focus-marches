...
if (isset($sirene['siren'])) {
    ...
    <div class="container">
        ...
        <div id="titulaires">
            ...
            <p><button id="getListeTitulaires" class="button has-text-link is-white"><i
                        class="fas fa-list-ol"></i>&nbsp;Liste des fournisseurs de cet acheteur</button></p>
        </div>
        ...
        if ($iframe == false) {
            ...
            $iframe_code_gen .= "window.addEventListener(\"message\",function(e){var t=document.getElementById(\"dynamic-iframe-acheteur-qui-realise\");if(e.data.height){console.log(\"Setting iframe height to:\",Math.max(600,Math.min(1200,e.data.height))+\"px\");t.style.height=Math.max(600,Math.min(1200,e.data.height))+\"px\"}},!1);function sendHeight(){var h=document.body.scrollHeight;window.parent.postMessage({height:h},\"*\")}window.onload=sendHeight;window.onresize=sendHeight;";
            $iframe_code_gen .= "</script>";
        ...
        <div class="modal-card">
            <section class="modal-card-body">
                ...
                <div id="modalMessageList">
                    ...
                    <table class="display table table-striped table-bordered table-hover dataTable no-footer" id="tableList"
...
<script>
    ...
    */
    ...
    $('#getListeTitulaires').on('click', function () {
        ...
        const id_acheteur = "<?php echo $id_acheteur_param; ?>";
